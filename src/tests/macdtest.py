...
class BadInitializationInput(unittest.TestCase):
    def testNoneParameter(self):
        ...
        self.assertRaises(IndicatorError, Macd, None)
        
    def testTupleParameter(self):
        """ initializing should fail with tuple parameter with one int """
        self.assertRaises(IndicatorError, Macd, (4, ))
        
    def testTupleTooLargeParameter(self):
        """ initializing should fail with tuple parameter length bigger than 3 """
        self.assertRaises(IndicatorError, Macd, (4, 12, 8, 3))
        
    def testTupleFirstParameterBiggerThanSecond(self):
        """ initializing should fail with first parameter bigger than second """
        self.assertRaises(IndicatorError, Macd, (12, 4, 8))
    ...
    def testEmptyParameter(self):
        ...
        self.assertRaises(TypeError, Macd)
